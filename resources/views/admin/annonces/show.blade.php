                    ...
                    <div class="table-responsive">
                        <table class="admin-table">
                            <thead>
                                <tr>
                                    <th>ID</th>
                                    <!-- Continuing resources/views/admin/annonces/show.blade.php -->
                                    <th>Type</th>
                                    <th>Utilisateur</th>
                                    <th>Date</th>
                                    <th>Statut</th>
        ...
        <div class="col-md-4">
            <div class="admin-card">
                ...
                <div class="admin-user-details">
                    ...
                    <div class="mt-3">
                        <a href="{{ route('admin.users.edit', $annonce->utilisateur->id) }}" class="admin-button w-100">
            ...
            <div class="admin-card mt-4">
                ...
                <div class="admin-actions-container">
                    @if($annonce->statut === 'en_attente')
                        <form action="{{ route('admin.annonces.approve', $annonce->id) }}" method="POST" class="mb-3">
                            @csrf
                            <button type="submit" class="admin-button admin-button-success w-100" onclick="return confirm('Êtes-vous sûr de vouloir approuver cette annonce ?')">
                    ...
                    @if($annonce->statut !== 'supprimee')
                        <form action="{{ route('admin.annonces.destroy', $annonce->id) }}" method="POST" class="mb-3">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="admin-button admin-button-danger w-100" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cette annonce ?')">
                                <i class="fas fa-trash"></i> Supprimer l'annonce
                            </button>
                        </form>
                    @endif
                    
                    <a href="{{ route('details', $annonce->id) }}" target="_blank" class="admin-button w-100 mb-3">
